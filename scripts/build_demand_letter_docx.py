...
def build():
    ...
    # 본문 제목
    para(doc, "제    목 :  조합 가입계약 해지 통지 및 분담금 전액 반환 청구의 건",
    ...
    para(doc,
         ...
         "업무대행총괄 김성수 이사와 약 47분간 면담하였고, 그 자리에서 ① 본인의 가입계약 "
         "해지(탈퇴) 의사를 명시적으로 표명하였으며, ② 김성수 이사는 이에 대하여 "
         "‘납입금 중 2,500만 원을 공제한 6,500만 원을 대체 조합원 모집 시(2024년 3월~8월 중) "
         "반환한다’고 안내한 바 있습니다. (위 면담 내용 일체는 통고인이 휴대전화로 녹음하여 "
         "별도 보관 중입니다.)",
    ...
    para(doc,
         "라. (해지 의사표시의 도달) 통고인은 본 통고서가 귀하들에게 도달한 날을 기준으로 "
         "민법 제111조에 따라 조합 가입계약을 ‘해지’하는 바이며, 이미 2023년 3월 15일 "
         "면담 시 김성수 이사를 통해 표시한 구두 해지 의사도 함께 원용합니다.",
         size=11, left_indent=0.7, space_after=12)
    ...
    para(doc,
         ...
         "면담 시 김성수 이사를 통하여 자인한 금 6,500만 원(공제액 2,500만 원에 대하여는 "
         "그 산정근거의 정당성을 다투며 별도 청구를 유보함)을 동 기한 내에 우선 반환할 것을 청구합니다.",
         size=11, left_indent=0.7, space_after=10)

    para(doc,
         "다. 위 기한 도과 시 반환 의무 발생일(본 통고서 도달일)로부터 변제일까지 "
         "상사법정이율 연 6%, 소제기 후부터는 소송촉진 등에 관한 특례법상 연 12%의 비율에 의한 "
         "지연손해금을 가산하여 청구하겠습니다.",
         size=11, left_indent=0.7, space_after=10)
