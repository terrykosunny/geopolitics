...
def build():
    ...
    para(doc, "(이미 해지된 조합 가입계약에 따른 분담금 반환 및 지연손해금 청구)",
    ...
    para(doc,
         "2. 김 성 수(金成洙) 이사   귀하\n"
         "    직    책 : 주식회사 다원에코코리아  업무대행총괄\n"
         "                (위 ‘1’항 조합의 업무대행사 ─ 등록번호 서울-주택2018-0062)\n"
         "    주    소 : 서울특별시 은평구 통일로 80길 16-6 (불광동, 주식회사 다원에코코리아 본점)",
    ...
    para(doc,
         ...
         "귀 조합이 비치하여 둔 ‘조합원 탈퇴서(또는 해지서) 양식’에 통고인이 자필로 서명·날인하여 "
         "이를 김성수 이사에게 직접 교부하였고, ② 이를 수령한 김성수 이사가 그 자리에서 "
         "‘조합 규약에 따라 해지가 됐으니, 납입금 중 2,500만 원을 공제한 6,500만 원을 "
         "대체 조합원 모집 시(2024년 3월~8월 중) 반환한다’고 답변함으로써, "
         "민법 제111조 제1항에 따라 통고인의 해지 의사표시 및 그에 따른 서면 탈퇴서가 "
         "상대방(귀 조합 및 그 업무대행총괄 이사)에게 적법하게 도달하여 "
         ...
         "이를 정리한 녹취록 및 통고인이 서명·교부한 탈퇴서 사본을 본 통고서에 첨부합니다.)",
         size=11, left_indent=0.7, space_after=6)
    ...
    para(doc,
         "가. (주된 청구원인 — 가입계약은 이미 적법하게 해지되었음) "
         "통고인의 가입계약은 2023년 3월 15일 통고인이 ‘조합원 탈퇴서’에 자필로 서명·날인하여 "
         "김성수 이사에게 직접 교부하고, 김성수 이사가 이를 수령하여 곧바로 ‘조합 규약에 따라 "
         "해지가 됐다’고 답변하면서 환불 절차(공제 후 6,500만 원 반환)를 직접 안내한 시점에 "
         "이미 종국적으로 적법하게 해지되었습니다(민법 제111조 제1항). "
         "따라서 본 통고서는 새로운 해지의 통지가 아니라, 위와 같이 이미 발생한 해지의 "
         "효력 확인 및 그에 따른 환불채무의 이행을 ‘다시 한번 최고(催告)’하는 의미를 가집니다 "
         "(민법 제387조 제2항, 제174조).",
         size=11, left_indent=0.7, space_after=6)

    para(doc,
         "나. (보충적 청구원인 — 가입계약상 ‘착공 후 분담금’ 조항 위반) "
         "통고인의 가입계약서에는 분담금을 ‘착공 후’ 납부하도록 명시되어 있음에도, "
         "귀 조합은 착공조차 이루어지지 아니한 상태에서 ‘중도금’이라는 명목을 빌어 사실상의 "
         "분담금을 강제 청구한 사실이 있습니다. 이는 개별 조합원과의 가입계약상 명시된 "
         "‘납부 시점에 관한 본질적 조항’을 총회 결의만으로 일방 변경한 것으로, 대법원 "
         "2014다63087 판결 등에 비추어 통고인에 대하여는 그 효력을 미칠 수 없으며, "
         "이는 통고인의 위 ‘가’항 탈퇴를 정당화하는 추가 사유에 해당합니다.",
         size=11, left_indent=0.7, space_after=6)

    para(doc,
         "다. (보충적 청구원인 — 모집공고 약정 위반 및 허위·과장 청약유인) "
         "귀 조합이 은평구청에 정식 등록·공지한 모집공고문 변경(안)에서는 ‘2022년 06월까지 약 95% "
         "이상의 토지매매계약 및 소유권이전 완료 후 주택건설 사업계획승인 신청’이 명시되어 "
         "있었음에도, 실제 약속 시점(2022.6.) 및 통고인의 탈퇴 시점(2023.3.15.) 모두 토지 "
         "매입률은 8%에 불과하였는바, 이는 「표시·광고의 공정화에 관한 법률」 제3조 제1항 제1호 "
         "(거짓·과장 표시·광고) 위반이자 민법 제110조(사기에 의한 의사표시) 취소사유에 해당하며, "
         "동시에 가입계약상 약정의 채무불이행에 해당합니다.",
         size=11, left_indent=0.7, space_after=6)

    para(doc,
         "라. (예비적 주장 — 임의탈퇴 금지 약정 등의 무효) "
         "가사 귀 조합 규약에 조합원의 임의 탈퇴를 일률적으로 제한하는 조항이 있다 하더라도, "
         "또한 신규 조합원 충원이라는 우연한 사정에 환불 시기를 결부시키는 약정이 있다 "
         "하더라도, 이는 신의성실의 원칙(민법 제2조) 및 약관규제법 제6조 등에 반하여 무효이므로, "
         "통고인의 위 ‘가’항 탈퇴의 효력에는 아무런 영향이 없습니다 "
    ...
    para(doc,
         ...
         "3. 2023년 3월 15일 통고인이 작성·서명·교부한 ‘조합원 탈퇴서’ 사본 1부.\n"
         "4. 2023년 3월 15일 김성수 이사 면담 녹취록 1부.\n"
         "5. 녹음 원본파일이 저장된 이동식 저장장치 1매.\n"
         "6. 「(가칭)연신내지역주택조합 조합원 모집 공고문 변경(안)」(은평구청 등록) 사본 1부.   끝.",
         size=11, left_indent=0.5, space_after=10)
